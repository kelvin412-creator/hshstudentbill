...
<body>
	<form action="../database/deletedata.php" method="post">
...
<div class="body"><h2>Remove Student</h2>
	...
	<tbody><?php 
		...
		if(isset($recieve)){
			...
			<td> <a href="../database/deletedata.php?st_id=<?=$detail['st_id'];?>">移除<i class="bi bi-trash3-fill"></i></a></td>
